      ...
      <div class="w-full bg-black rounded-lg shadow dark:border md:mt-0 sm:max-w-md xl:p-0 dark:bg-black dark:border-gray-700">
          <div class="p-6 space-y-4 md:space-y-6 sm:p-8">
              ...
              <form class="space-y-4 md:space-y-6" action="index.php" method="post">
                ...
                <!-- <div class="flex items-center p-4 mb-4 text-sm text-red-800 border border-red-300 rounded-lg bg-black dark:bg-black dark:text-red-400 dark:border-red-800" role="alert">
              ...
              <?php endforeach; ?>
                  ...
                  <button type="submit" name="signup-btn" class="w-full text-black bg-white hover:bg-gray-700 focus:ring-4 focus:outline-none focus:ring-primary-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-white hover:text-white dark:hover:text-white dark:hover:bg-gray-700 dark:focus:ring-primary-800">Register</button>
